...
// [تعديل] تم حذف Sun, Moon لأن زر التبديل لم يعد موجوداً
...
export default function Navbar() {
  ...
  // [تعديل] لا حاجة لاستخدام theme هنا
  ...
  // [تعديل] تم تغيير dark:bg-gray-900/80 إلى bg-white/80 لفرض الفاتح
  // وتم تغيير dark:border-gray-700 إلى border-gray-200 لفرض الفاتح
  if (isLoading) {
    return (
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            {user ? (
              <>
                ...
                {/* [تعديل] تم إزالة تنسيقات الوضع الداكن من زر الخروج */}
                <button
